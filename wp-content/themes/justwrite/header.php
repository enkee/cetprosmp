        ...
        <div class="wrap">
            ...
            <div class="top<?php ac_mini_disabled(); ac_logo_class(); ?> clearfix">
                ...
                <div class="logo<?php ac_logo_class(); ?>">
                    <a href="<?php echo esc_url( home_url() ); ?>" title="<?php bloginfo( 'name' ); ?>" class="logo-contents<?php ac_logo_class(); ?>">
                        <?php ac_get_logo(); ?></a>
                    <?php
		...
		if ( $ad728_show && $ad728_code != '' && ! $logocentered ) : ?>
			...
			if( has_nav_menu( 'main' ) ) {
				wp_nav_menu( array( 
                    'container' => '', 
                    'theme_location' => 'main',
                    'items_wrap' => '<ul class="menu-main mobile-menu superfish">%3$s</ul>',
                ) );
			} else {
